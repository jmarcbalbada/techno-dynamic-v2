      ...
      <AccordionDetails>
        <Box
          ...
          <Box
            ...
            alignItems='center'
            component='a' 
            href='https://www.facebook.com/CITUWildcatInnovLabs' 
            target='_blank' 
          ...
          <Box
            ...
            alignItems='center'
            component='a' 
            href='mailto:wildcatinnovationlabs@gmail.com' 
            target='_blank' 
            rel='noopener noreferrer'
            sx={{
              textDecoration: 'none',
          ...
          >
            <MdAlternateEmail
              size={28}
              color={theme.palette.primary.main}
              style={{ marginRight: '0.5rem' }} // Adjust spacing between icon and text
            />
            <Typography variant='body2' sx={{ fontWeight: 500 }}>
              wildcatinnovationlabs@gmail.com
            </Typography>
          </Box>
        </Box>
      </AccordionDetails>
