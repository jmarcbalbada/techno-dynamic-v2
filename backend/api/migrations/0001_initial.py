# Generated by Django 4.2.1 on 2024-06-03 12:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('similiarity_threshold', models.FloatField(default=0.7)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('content', models.TextField()),
                ('faq', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='api.faq')),
                ('related_content', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contents', to='api.relatedcontent')),
            ],
        ),
    ]
