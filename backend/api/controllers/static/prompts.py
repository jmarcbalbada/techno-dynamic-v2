...
def prompt_create_content_abs(faq_questions,lesson_content_text):
  ...
  input_text = f"""
            ...
            VERY IMPORTANT NOTE: YOU WILL ONLY give <mark></mark> of background-color: lightcoral; IF THESE ARE FROM THE ORIGINAL CONTENT BECAUSE IT WILL BE TOO DUMB IF YOU REMOVING SOMETHING IF THEY DIDNT EXIST IN ORIGINAL CONTENT
            ...
            IT IS EXPECTED THAT YOU HAVE SUMMARY AT THE END, SUMMARIZING THE TOPIC. IF THERE IS A YOUTUBE LINK VIDEO FROM ORIGINAL LESSON CONTENT YOU MUST RETAIN IT AND PUT 1 <br> below it  .
